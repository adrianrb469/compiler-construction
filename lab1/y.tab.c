...
{
       0,    31,    31,    34,    35,    38,    39,    40,    43,    47,
      48,    59,    60,    61,    62,    63,    71
};
#endif
...
{
      34,    21,   -10,     7,    13,    26,   -10,   -10,     1,    38,
     -10,   -10,    38,    38,    38,    38,   -10,   -10,     9,    10,
      -7,    -7,   -10,   -10,    38,    25
};
...
{
       0,    16,     9,    10,     0,     0,     3,     5,     0,     0,
       1,     4,     0,     0,     0,     0,     6,    16,    10,     8,
      12,    13,    14,    15,     0,    11
};
...
{
      19,    14,    15,    20,    21,    22,    23,    12,    13,    14,
      15,    16,     9,    10,    24,    25,    12,    13,    14,    15,
     -11,    -7,    -7,    11,    -7,    -7,    -2,     1,     0,     2,
       3,    12,    13,    14,    15,     1,     0,     2,     3,    17,
       0,     2,    18
};

static const yytype_int8 yycheck[] =
{
       9,     8,     9,    12,    13,    14,    15,     6,     7,     8,
       9,    10,     5,     0,     5,    24,     6,     7,     8,     9,
      10,     0,     1,     5,     3,     4,     0,     1,    -1,     3,
       4,     6,     7,     8,     9,     1,    -1,     3,     4,     1,
      -1,     3,     4
};
...
#line 39 "./files/simple_language.y"
                     { std::cout << "Result: " << (yyvsp[-1].num) << std::endl; }
#line 1151 "y.tab.c"
    break;

  case 7: /* statement: error  */
#line 40 "./files/simple_language.y"
            { yyerror("Syntax error in statement. Please check your input."); yyclearin; }
#line 1157 "y.tab.c"
    break;

  case 8: /* assignment: ID '=' expression  */
#line 44 "./files/simple_language.y"
        { vars[*(yyvsp[-2].str)] = (yyvsp[0].num); delete (yyvsp[-2].str); std::cout << "Assigned " << *(yyvsp[-2].str) << " = " << (yyvsp[0].num) << std::endl; }
#line 1163 "y.tab.c"
    break;
...
#line 48 "./files/simple_language.y"
         { 
        if (vars.find(*(yyvsp[0].str)) == vars.end()) {
            // if variable not found, return 0
            yyerror("Variable not found.");
            (yyval.num) = 0;
            return 0;
        }
        (yyval.num) = vars[*(yyvsp[0].str)]; 
        delete (yyvsp[0].str);  
        std::cout << "Value of " << *(yyvsp[0].str) << " = " << (yyvsp[0].str) << std::endl;
    }
#line 1185 "y.tab.c"
    break;

  case 11: /* expression: ID '=' expression  */
#line 59 "./files/simple_language.y"
                        { vars[*(yyvsp[-2].str)] = (yyvsp[0].num); delete (yyvsp[-2].str); (yyval.num) = (yyvsp[0].num); }
#line 1191 "y.tab.c"
    break;
...
#line 61 "./files/simple_language.y"
                                { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1203 "y.tab.c"
    break;

  case 14: /* expression: expression '*' expression  */
#line 62 "./files/simple_language.y"
                                { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1209 "y.tab.c"
    break;
...
#line 71 "./files/simple_language.y"
            { yyerror("Syntax error in expression. Please check your input."); yyclearin; }
#line 1228 "y.tab.c"
    break;
...
#line 74 "./files/simple_language.y"
