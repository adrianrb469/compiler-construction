...
class CompiscriptVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CompiscriptParser#init.
    ...
    # Visit a parse tree produced by CompiscriptParser#logicOr.
    def visitLogicOr(self, ctx:CompiscriptParser.LogicOrContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CompiscriptParser#logicAnd.
    ...
    # Visit a parse tree produced by CompiscriptParser#methods.
    def visitMethods(self, ctx:CompiscriptParser.MethodsContext):
        return self.visitChildren(ctx)
