...
class CompiscriptListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CompiscriptParser#logicOr.
    def enterLogicOr(self, ctx:CompiscriptParser.LogicOrContext):
        pass

    # Exit a parse tree produced by CompiscriptParser#logicOr.
    def exitLogicOr(self, ctx:CompiscriptParser.LogicOrContext):
        pass


    # Enter a parse tree produced by CompiscriptParser#logicAnd.
    def enterLogicAnd(self, ctx:CompiscriptParser.LogicAndContext):
        pass

    # Exit a parse tree produced by CompiscriptParser#logicAnd.
    def exitLogicAnd(self, ctx:CompiscriptParser.LogicAndContext):
        pass
    ...
    # Enter a parse tree produced by CompiscriptParser#functions.
    def enterFunctions(self, ctx:CompiscriptParser.FunctionsContext):
        pass

    # Exit a parse tree produced by CompiscriptParser#functions.
    def exitFunctions(self, ctx:CompiscriptParser.FunctionsContext):
        pass
